import StartSoterAuthenticationSuccessCallbackResult = WechatMiniprogram.StartSoterAuthenticationSuccessCallbackResult;
 ...
 */
export const luminaStartSoter = async (challenge: string): Promise<StartSoterAuthenticationSuccessCallbackResult | null> => {
 ...
 */
export const weixinStartSoter = async (challenge: string, mode: ("fingerPrint" | "facial" | "speech")[]): Promise<StartSoterAuthenticationSuccessCallbackResult | null> => {
